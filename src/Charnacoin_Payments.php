 ...
 */
 ...
 class Charnacoin_Payments{
     ...
     *  @param  $ip   IP of Charnacoin RPC
     *  @param  $port Port of Charnacoin RPC
     */
   ...
   /**
    * Print Charnacoin Address as JSON Array
    * @return $address
    */
   ...
   /*
    * Print Charnacoin Balance as JSON Array
    */
  ...
  /*
    * Print Charnacoin Height as JSON Array
    */
  ...
  public function create_wallet($filename = 'charnacoin_wallet', $password){
